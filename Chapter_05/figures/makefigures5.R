...
tiff("figure5_4_color.tif",width=5,height=5,units="in",res=1200)
efficiency(undil)
arrows(8,4500,20,3200,length=0.05)
text(8,4500,"actual\nefficiency",adj=c(0.5,0),cex=0.7)
arrows(8,3500,23,570,length=0.05)
text(8,3500,"1st derivative",adj=c(0.5,0),cex=0.7)
arrows(8,2000,21,90,length=0.05)
text(8,2000,"2nd derivative",adj=c(0.5,0),cex=0.7)
text(24.5,5000,"cpD1: 24.8",srt=90,adj=c(0.5,0),cex=0.7)
text(21.1,5000,"cpD2: 21.1",srt=90,adj=c(0.5,0),cex=0.7)
text(34,2750,"overall efficiency: 1.49",adj=c(0.5,0),cex=0.7)
text(34,1000,"optimal threshold: 975",adj=c(0.5,0),cex=0.7)
dev.off()
